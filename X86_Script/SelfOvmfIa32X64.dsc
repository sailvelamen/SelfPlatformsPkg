...
################################################################################
[Defines]
  PLATFORM_NAME                  = SelfOvmf3264
  PLATFORM_GUID                  = 5CD50958-53DC-DEF7-DA2C-16B6B118C4E4
  ...
  FLASH_DEFINITION               = SelfPlatformsPkg/X86_Script/SelfOvmfIa32X64.fdf
...
[PcdsFixedAtBuild.common]
  gEfiMdeModulePkgTokenSpaceGuid.PcdFirmwareVersionString|L"0.0.0"
...
!include OvmfPkg/Include/Dsc/OvmfTpmSecurityStub.dsc.inc
  ...
  SelfPkg/Universal/DriverSampleDxe/DriverSampleDxe.inf    # fanjix
  SelfPkg/Universal/BootOptionsDxe/BootOptionsDxe.inf      # fanjix  
  ...
  MdeModulePkg/Application/UiApp/UiApp.inf {
    <LibraryClasses>
      NULL|SelfPkg/Universal/TestUiLib/TestUiLib.inf
...
!endif
  ...
  SelfPkg/Universal/UEFIDriverDxe/UEFIDriverDxe.inf  # fanjix
  ...
  SelfPkg/Universal/InstallACPI/InstallACPI.inf  # fanjix
  #
...
!if $(SMM_REQUIRE) == TRUE
  ...
  # Self DXE_SMM_DRIVER
  #
  SelfPkg/Universal/SwSmiDemo/SwSmiDemo.inf  # fanjix
!else
